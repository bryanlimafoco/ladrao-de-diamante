...
textSize (30)
  fill('yellow')
 text ('voce capturou o diamante',45,200) 
text ( 'va ate a proximo',50,230)
    fill('white')
   textSize(15) 
   text('Pressione r para reiniciar',100,260) 
...
laser2.shapeColor =  ' #F70606'
diamante.shapeColor = ' rgb(10,195,255)'
